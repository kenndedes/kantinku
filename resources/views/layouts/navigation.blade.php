            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif ($role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.stands.index')" :active="request()->routeIs('admin.stands.*')">
                            {{ __('Stand') }}
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('admin.topup.index')" :active="request()->routeIs('admin.topup.*')">
                            {{ __('Top Up') }}
                        </x-nav-link>
                    @elseif ($role === 'seller')
                        ...
                        <x-nav-link :href="route('seller.menu.index')" :active="request()->routeIs('seller.menu.*')">
                            {{ __('Menu Stand') }}
                        </x-nav-link>
                        <x-nav-link :href="route('seller.reports.index')" :active="request()->routeIs('seller.reports.*')">
                            {{ __('Laporan') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif ($role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.stands.index')" :active="request()->routeIs('admin.stands.*')">
                    {{ __('Stand') }}
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('admin.topup.index')" :active="request()->routeIs('admin.topup.*')">
                    {{ __('Top Up') }}
                </x-responsive-nav-link>
            @elseif ($role === 'seller')
                ...
                <x-responsive-nav-link :href="route('seller.menu.index')" :active="request()->routeIs('seller.menu.*')">
                    {{ __('Menu Stand') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('seller.reports.index')" :active="request()->routeIs('seller.reports.*')">
                    {{ __('Laporan') }}
                </x-responsive-nav-link>
            @endif
        </div>
