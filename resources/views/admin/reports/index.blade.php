...
<div class="space-y-6 py-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Ringkasan transaksi seluruh stand</p>
        </div>
        <div class="flex gap-2 flex-wrap">
            <a href="{{ route('admin.reports.exportExcel', request()->query()) }}"
    ...
    <form method="GET" action="{{ route('admin.reports.index') }}"
        ...
        <div>
            ...
            <select name="stand_id" class="w-full border rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-purple-300 focus:border-purple-400 outline-none">
    ...
    <div class="bg-white rounded-2xl shadow overflow-hidden">
        <div class="px-5 py-4 border-b">
            <h2 class="font-semibold text-gray-700">Ringkasan per Stand</h2>
        </div>
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-5 py-3 font-medium text-gray-800">{{ $row['stand'] }}</td>
                    <td class="px-5 py-3 text-right text-gray-600">{{ number_format($row['total_orders']) }}</td>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-3 text-gray-600">{{ $order->stand?->name ?? '-' }}</td>
