<x-app-layout>
    ...
    <div class="space-y-6 p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 sm:p-8">
            <form method="POST" action="{{ route('admin.menu.store') }}" class="space-y-6" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <select id="stand_id" name="stand_id" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200" required>
                        ...
                        @foreach ($stands as $stand)
                            <option value="{{ $stand->id }}" @selected(old('stand_id') == $stand->id)>{{ $stand->name }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200" placeholder="Contoh: Nasi Goreng Spesial" required>
                ...
                <div>
                    ...
                    <input id="price" type="number" name="price" value="{{ old('price') }}" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200" min="1000" step="100" placeholder="10000" required>
                ...
                <div>
                    ...
                    <input id="stock" type="number" name="stock" value="{{ old('stock', 0) }}" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200" min="0" required>
                ...
                <div class="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    <input id="is_available" type="checkbox" name="is_available" value="1" class="w-5 h-5 rounded border-gray-300 text-primary-600 focus:ring-primary-500 cursor-pointer" @checked(old('is_available', true))>
