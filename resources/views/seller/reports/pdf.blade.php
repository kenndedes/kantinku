...
<head>
    <meta charset="utf-8">
    <title>Laporan Stand {{ $standName }}</title>
    <style>
        * { font-family: Arial, sans-serif; font-size: 11px; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .standname { font-size: 13px; color: #5b21b6; margin-bottom: 4px; }
...
<body>
    <h1>E-Canteen &mdash; Laporan Stand</h1>
    <p class="standname">{{ $standName }}</p>
    <p class="subtitle">
